...
const Handle = React.forwardRef<HTMLDivElement, HandleProps>((props, ref) => {
  ...
  // ============================ Offset ============================
  const positionStyle = getDirectionStyle(direction, value, min, max, entity?.positionFixer);
  ...
  let handleNode = (
    <div
      ...
      {...restProps}
    >
      <div className={`${handlePrefixCls}-pointer`} />
      <div className={`${handlePrefixCls}-inner-container`}>
        <div className={`${handlePrefixCls}-inner-pointer`} />
        {handleInnerComponent}
      </div>
      {handleActionComponent}
    </div>
